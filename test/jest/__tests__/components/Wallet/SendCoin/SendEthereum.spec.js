  ...
  describe('Fee section', () => {
    ...
    it('updates the estimatedFee if the amount is maxed', async (done) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          expect(wrapper.vm.estimatedFee).toBe('£0.00');
          done();
        }, 750);
      }, 25);
    });
