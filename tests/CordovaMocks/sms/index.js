function Sms() {
  ...
  this.hasPermission = function (callback1, callback2) {
  ...
  this.requestPermission = function (callback1, callback2) {
  ...
  this.send = function (number, message, options, success, error) {
